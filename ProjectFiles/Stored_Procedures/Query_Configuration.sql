...
INSERT INTO service(serviceName)
	...
	,'Excel 12.0;Database=C:\Users\Autobots\Desktop\ProjectFiles\Services.xlsx;HDR=YES'
	,'SELECT * FROM [Sheet1$]')
GO
...
INSERT INTO country(callingCode, countryName)
	...
	FROM OPENROWSET(
	'Microsoft.ACE.OLEDB.16.0'
	,'Excel 12.0;Database=C:\Users\Autobots\Desktop\ProjectFiles\Calling_Codes.xls;HDR=YES'
	,'SELECT * FROM [Sheet1$]')
GO
...
INSERT INTO salesRep(salesRepId)
	...
	FROM OPENROWSET(
	'Microsoft.ACE.OLEDB.16.0'
	,'Excel 12.0;Database=C:\Users\Autobots\Desktop\ProjectFiles\salesRep.xlsx;HDR=YES'
	,'SELECT * FROM [Sheet1$]')
GO
...
INSERT INTO #peakTimes(sName, cName, peakStart,offPeakStart)
	...
	FROM OPENROWSET(
	'Microsoft.ACE.OLEDB.16.0'
	,'Excel 12.0;Database=C:\Users\Autobots\Desktop\ProjectFiles\PeakTimes.xlsx;HDR=YES'
	,'SELECT * FROM [Sheet1$]')
GO
